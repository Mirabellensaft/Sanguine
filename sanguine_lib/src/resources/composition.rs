                ...
                match self.0[row][col] {
                    Density::Empty => {
                        ...
                        match contact {
                            ...
                            [true, true, true, false] => self.0[row][col] = Density::ThreeWay(Direction::Right),
                            [true, false, true, true] => self.0[row][col] = Density::ThreeWay(Direction::Left),
                            [true, true, false, true] => self.0[row][col] = Density::ThreeWay(Direction::Down),
                            [false, true, true, true] => self.0[row][col] = Density::ThreeWay(Direction::Up),

                            [true, true, false, false] => self.0[row][col] = Density::Corner(Direction::LeftUp),
                            [false, true, true, false] => self.0[row][col] = Density::Corner(Direction::LeftDown),
                            [false, false, true, true] => self.0[row][col] = Density::Corner(Direction::RightDown),
                            [true, false, false, true] => self.0[row][col] = Density::Corner(Direction::RightUp),
                            

                            [false, false, false, true] => self.0[row][col] = Density::Edge(Direction::Left),
                            [true, false, false, false] => self.0[row][col] = Density::Edge(Direction::Up),
                            [false, false, true, false] => self.0[row][col] = Density::Edge(Direction::Down),
                            [false, true, false, false] => self.0[row][col] = Density::Edge(Direction::Right),

                            [false, true, false, true] => self.0[row][col] = Density::Transition(Direction::LeftRight),
                            [true, false, true, false] => self.0[row][col] = Density::Transition(Direction::UpDown),
